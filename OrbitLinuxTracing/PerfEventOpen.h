...
// perf_event_open for mmap.
int32_t mmap_event_open(pid_t pid, int32_t cpu);

// perf_event_open for task (fork and exit) and mmap in a single ring buffer.
...
int32_t sample_mmap_task_event_open(uint64_t period_ns, pid_t pid, int32_t cpu);
